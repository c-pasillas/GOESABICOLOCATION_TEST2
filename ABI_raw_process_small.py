...
def main(args):
   ...
   #keylist is a list of the times that i need to iterate over, its also the keys in the largest dict
    ...
    #process  small batch DTGs through the satpy colocation and save a final .npz of all the data
    ...
    case1 = {c: np.stack(tuple(d[c][:min_rows, :min_cols] for d in datas)) for c in channels}
    ...
    filename = GOESpath / f'{GOESpath.name}_RefGOES_case_0-20.npz'
    ...
    #for datetime in sorted(matched)[20:40]:
     #   log.info(f"the DTG is, {datetime}, and matched[datetime] is {matched[datetime]}")
     #   try:
      #      datas2.append(process_set(matched[datetime], dcount2, len(matched)))
       #     dcount2 += 1
    ...
    #print("starting the cropping for case 2")
    #min_rows, min_cols = ft.reduce(crop.pairwise_min, [x['DNB'].shape for x in datas2])
    #print(min_rows, min_cols)
    #print("the xDNB shape is", x['DNB'].shape)
    #channels = datas2[0]['channels']
    #print("the channels are", channels)
    #print("starting the stacking")
    #case2 = {c: np.stack(tuple(d[c][:min_rows, :min_cols] for d in datas2)) for c in channels}
    #case = {c: np.stack(tuple(d[c] for d in datas)) for c in channels}
    ...
    #filename2 = /gdata5/cpasilla/DATA/f'{path.name}_RefGOES_case.npz'
    #filename = GOESpath / f'{GOESpath.name}_RefGOES_case_20-40.npz'
    #log.info(f'Writing {blue}{filename.name}{reset}\n' +
     #        f'{orange}Channels{reset} {channels}\n{orange}')
    ...
    #    log.info(f"the DTG is, {datetime}, and matched[datetime] is {matched[datetime]}")
     #   try:
      #      datas3.append(process_set(matched[datetime], dcount3, len(matched)))
       #     dcount3 += 1
        ...
        #except IndexError:
         #   log.info(f"skipped {dcount3} due to an incomplete dataset")
          #  continue
    #print("starting the cropping for case 3")
    #min_rows, min_cols = ft.reduce(crop.pairwise_min, [x['DNB'].shape for x in datas3])
    #print(min_rows, min_cols)
    #print("the xDNB shape is", x['DNB'].shape)
    #channels = datas3[0]['channels']
    #print("the channels are", channels)
    #print("starting the stacking")
    #case3 = {c: np.stack(tuple(d[c][:min_rows, :min_cols] for d in datas3)) for c in channels}
    #case = {c: np.stack(tuple(d[c] for d in datas)) for c in channels}
    ...
    #filename2 = /gdata5/cpasilla/DATA/f'{path.name}_RefGOES_case.npz'
    #filename = GOESpath / f'{GOESpath.name}_RefGOES_case_40-60.npz'
    #log.info(f'Writing {blue}{filename.name}{reset}\n' +
     #        f'{orange}Channels{reset} {channels}\n{orange}')
    ...
    #for datetime in sorted(matched)[60:80]:
     #   log.info(f"the DTG is, {datetime}, and matched[datetime] is {matched[datetime]}")
      #  try:
       #     datas4.append(process_set(matched[datetime], dcount4, len(matched)))
        #    dcount4 += 1
    ...
    #print("starting the cropping for case 4")
    #min_rows, min_cols = ft.reduce(crop.pairwise_min, [x['DNB'].shape for x in datas4])
    #print(min_rows, min_cols)
    #print("the xDNB shape is", x['DNB'].shape)
    #channels = datas4[0]['channels']
    #print("the channels are", channels)
    #print("starting the stacking")
    #case4 = {c: np.stack(tuple(d[c][:min_rows, :min_cols] for d in datas4)) for c in channels}
    #case = {c: np.stack(tuple(d[c] for d in datas)) for c in channels}
    ...
    #filename2 = /gdata5/cpasilla/DATA/f'{path.name}_RefGOES_case.npz'
    #filename = GOESpath / f'{GOESpath.name}_RefGOES_case_60-80.npz'
    #log.info(f'Writing {blue}{filename.name}{reset}\n' +
     #        f'{orange}Channels{reset} {channels}\n{orange}')
    ...
    #for datetime in sorted(matched)[80:-1]:
     #   log.info(f"the DTG is, {datetime}, and matched[datetime] is {matched[datetime]}")
      #  try:
       #     datas5.append(process_set(matched[datetime], dcount5, len(matched)))
        #    dcount5 += 1
    ...
    #print("starting the cropping for case 5")
    #min_rows, min_cols = ft.reduce(crop.pairwise_min, [x['DNB'].shape for x in datas5])
    #print(min_rows, min_cols)
    #print("the xDNB shape is", x['DNB'].shape)
    #channels = datas5[0]['channels']
    #print("the channels are", channels)
    #print("starting the stacking")
    #case5 = {c: np.stack(tuple(d[c][:min_rows, :min_cols] for d in datas5)) for c in channels}
    #case = {c: np.stack(tuple(d[c] for d in datas)) for c in channels}
    ...
    #filename2 = /gdata5/cpasilla/DATA/f'{path.name}_RefGOES_case.npz'
    #filename = GOESpath / f'{GOESpath.name}_RefGOES_case_80+.npz'
    #log.info(f'Writing {blue}{filename.name}{reset}\n' +
     #        f'{orange}Channels{reset} {channels}\n{orange}')
    ...
    #log.info(f'all done with {GOESpath.name} files')
